#!/bin/bash
#SBATCH --job-name=salm-small-gh
#SBATCH --output=salm-small%j.out
#SBATCH --error=salm-small%j.err
...
torchrun --standalone --nproc_per_node=4 models/salm.py \
    --output_dir "$OUTPUT_DIR" \
